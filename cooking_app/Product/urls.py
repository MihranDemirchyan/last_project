...
urlpatterns = [
    path('products/<int:product_id>/', product_view.ProductView.as_view()),
    path('products_create/', product_view.ProductCreationView.as_view()),
    ...
    path('comments/<int:product_id>/', comments_view.CommentsListView.as_view()),
    ...
    path('likes_get/<int:product_id>/', likes_view.GetProductLikesView.as_view()),
